    ...
    (function() {
      ...
      const setup = (editor) => {
        editor.editorManager.on("BeforeUnload", (e) => {
          let msg;
          global$1.each(global.get(), (editor2) => {
...
// dep:tinymce_plugins_autosave
var tinymce_plugins_autosave_default = require_autosave();
export {
  tinymce_plugins_autosave_default as default
};
//# sourceMappingURL=tinymce_plugins_autosave.js.map
