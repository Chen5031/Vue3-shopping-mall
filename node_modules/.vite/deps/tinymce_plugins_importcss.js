    ...
    (function() {
      ...
      const getSelectors = (editor, doc, fileFilter) => {
        ...
        const append = (styleSheet, imported) => {
          ...
          global.each(styleSheet.imports, (styleSheet2) => {
      ...
      const get = (editor) => {
        const convertSelectorToFormat2 = (selectorText) => {
...
var require_importcss = __commonJS({
  "node_modules/tinymce/plugins/importcss/index.js"() {
    require_plugin();
  }
});

// dep:tinymce_plugins_importcss
var tinymce_plugins_importcss_default = require_importcss();
export {
  tinymce_plugins_importcss_default as default
};
//# sourceMappingURL=tinymce_plugins_importcss.js.map
