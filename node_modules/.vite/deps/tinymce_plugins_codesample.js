...
var require_plugin = __commonJS({
  "node_modules/tinymce/plugins/codesample/plugin.js"() {
    (function() {
      ...
      const prismjs = function(global2, module2, exports2) {
        ...
        (function(Prism2) {
          ...
          Prism2.languages.insertBefore("inside", "double-colon", { "class-name": /\b[a-z_]\w*\b(?!\s*::)/i }, Prism2.languages.cpp["base-clause"]);
        })(Prism);
        (function(Prism2) {
          ...
          if (unprocessedCodeSamples.length) {
            editor.undoManager.transact(() => {
              global.each(unprocessedCodeSamples, (elm) => {
                var _a;
                global.each(dom.select("br", elm), (elm2) => {
        ...
        editor.on("PreInit", () => {
          editor.parser.addNodeFilter("pre", (nodes) => {
            ...
            for (let i = 0, l = nodes.length; i < l; i++) {
              const node = nodes[i];
              const isCodeSample2 = ((_a = node.attr("class")) !== null && _a !== void 0 ? _a : "").indexOf("language-") !== -1;
              if (isCodeSample2) {
...
var require_codesample = __commonJS({
  "node_modules/tinymce/plugins/codesample/index.js"() {
    require_plugin();
  }
});

// dep:tinymce_plugins_codesample
var tinymce_plugins_codesample_default = require_codesample();
export {
  tinymce_plugins_codesample_default as default
};
//# sourceMappingURL=tinymce_plugins_codesample.js.map
